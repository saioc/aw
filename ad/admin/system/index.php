...
<div class="row stats">
  ...
  <div class="col-md-3">
    <div class="panel panel-default panel-green">
      <div class="panel-body">
        ...
        <p>+ <?php echo $this->config["tracking"]=="2" ? "Not Available" : $this->db->count("stats","date>=curdate()")." 今日" ?></p>
      </div>
    </div>
  </div> 
  <div class="col-md-3">
  ...
  <div class="col-md-3">
    <div class="panel panel-default panel-black">
      <div class="panel-body">
        <p class="main-stats"><span><?php echo date("F") ?>月份 <?php echo Main::currency($this->config["currency"],$this->db->count("payment","(MONTH(date) = MONTH(CURDATE()) AND YEAR(date) = YEAR(CURDATE())) AND status='Completed'","amount") - $this->db->count("payment","(MONTH(date) = MONTH(CURDATE()) AND YEAR(date) = YEAR(CURDATE())) AND status='Refunded'","amount")) ?></span> </p>
...
<div class="row">
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">最新用户</div>      
      <div class="panel-body">
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">最新付款</div>      
      <div class="panel-body">
        <div class="table-responsive">
          <table class="table table-striped">
            <thead>
