...
<html lang="zh">
  ...
  <body id="main">
    <a href="#main" id="back-to-top">回到顶部</a>
        ...
        <div class="row">
          ...
          <div class="navbar-collapse collapse">         
            <form class="navbar-form navbar-left search" action="<?php echo Main::ahref("search") ?>">
              <input type="text" class="form-control" size="80" placeholder="搜索用户、URL或支付并按回车键" name="q">
            </form>             
            <ul class="nav navbar-nav navbar-right">
              <li><a href="<?php echo $this->config["url"] ?>" target="_blank"><span class="glyphicon glyphicon-globe"></span> 首页</a></li>
      ...
      <div class="row">
        <div class="col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="<?php echo $this->url ?>/"><span class="glyphicon glyphicon-dashboard"></span> 主页</a></li>
            <li><a href="<?php echo Main::ahref("urls") ?>"><span class="glyphicon glyphicon-link"></span> 网址</a></li>
            <li><a href="<?php echo Main::ahref("users") ?>"><span class="glyphicon glyphicon-user"></span> 用户</a></li>
            <li><a href="<?php echo Main::ahref("payments") ?>"><span class="glyphicon glyphicon-usd"></span> 支付</a></li>
            <li><a href="<?php echo Main::ahref("subscription") ?>"><span class="glyphicon glyphicon-refresh"></span> 订阅</a></li>
            <li><a href="<?php echo Main::ahref("pages") ?>"><span class="glyphicon glyphicon-book"></span> 网页</a></li>
            <li><a href="<?php echo Main::ahref("themes") ?>"><span class="glyphicon glyphicon-eye-open"></span> 模板</a></li>
            <li><a href="<?php echo Main::ahref("languages") ?>"><span class="glyphicon glyphicon-globe"></span> 语言</a></li>
            <li><a href="<?php echo Main::ahref("settings") ?>"><span class="glyphicon glyphicon-cog"></span> 设置</a></li> 
            <li><a href="<?php echo Main::ahref("settings/optimize") ?>"><span class="glyphicon glyphicon-refresh"></span> 优化数据库</a></li>
          </ul>
        </div>
