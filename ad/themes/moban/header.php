...
<html lang="en" prefix="og: http://ogp.me/ns#">
  <head>       
    ...
    <meta name="keywords" content="<?php echo $this->config["keywords"] ?>" ,wosuo/>
    <!-- Open Graph Tags -->
    <?php echo Main::ogp(); ?> 

    <title><?php echo Main::title() ?>短网址 - 网址缩短 wosuo.net</title> 
          ...
          <div class="navbar" role="navigation">
            <div class="container">
              ...
              <div class="navbar-collapse collapse">
                ...
                <script>             
                  var html = "";
                   html+="<li><a href='http://cloud.wosuo.net'>我缩云盘</a></li><li><a href='https://pic.wosuo.net'>图片外链</a></li><li><a href='/user/login'>登录</a></li><li><a href='/user/register' class='active'>注册</a></li>";
