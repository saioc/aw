...
add_shortcode("shorten", "shortcode_shorten_url"); </pre></p>
               ...
               <p><?php echo e("To shorten a URL in your post, simply use <strong> [ shorten ]THEURL [ /shorten ]</strong>. To shorten things like the permalink of the post or page, see the example below.") ?></p>
              <h5><?php echo e("Shortening Permalinks in your theme files") ?></h5>
               <p><?php echo e("Now that you set up the function, you can freely use it anywhere you want. All you have to do is to call the main function and provide the URL. If for example you want to shorten the permalink of a post or a page you can use the following code in any part of your template.") ?></p>
               <p><pre>&lt;?php echo shorten_url(get_permalink()) ?&gt; </pre></p>
